...
%opening
\title{TopKLists: Usage of the module \texttt{TopKSpace}}
%\VignetteIndexEntry{Usage of TopKSpace} 
\author{Shili Lin, Karl G. Kugler}
...
\section{Comparison of the performance of the different algorithms}
