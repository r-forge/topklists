...
\begin{itemize}
    ...
    \item A Clinically Relevant Gene Signature in Triple-Negative and Basal-Like Breast Cancer (2011)\footnote{http://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE20271} - data called \textit{Pusztai} \cite{tabchy}
\end{itemize}
