...
be identical. On the other hand, the common-space results are different from those assuming top-k
space. 
...
<<deltaplot_complete, echo=TRUE, include=TRUE, fig.pos="H", fig.keep='first',  fig.align="center", tidy=TRUE, out.width='9cm', out.height='9cm',fig.cap="Deltaplot for lists MDCC vs. Pusztai">>=
