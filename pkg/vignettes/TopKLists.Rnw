...
\begin{itemize}
    \item MicroArray Quality Control Phase II Project (2010)\footnote{http://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE20194} - data called \textit{MDACC} \cite{popovici,shi}
    ...
    \item A Clinically Relevant Gene Signature in Triple-Negative and Basal-Like Breast Cancer (2011)\footnote{http://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE31519} - data called \textit{Pusztai} \cite{karn2011,karn2012,rody}
\end{itemize}
