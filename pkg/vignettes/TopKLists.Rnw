...
<<mydelta>>=
a=deltaplot(breast, plotpdf=TRUE, directory=tempdir()) 
@ 

\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{\Sexpr{tempdir()}/deltaplotL1-2.pdf}\\
...
<<mydelta2>>=
a=deltaplot(breast, deltas = 1:50, subset.lists=200, subplot = TRUE, perc.subplot=50, plotpdf=TRUE, directory=tempdir())
@
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.35]{\Sexpr{tempdir()}/subplotL1-2.pdf}\\
